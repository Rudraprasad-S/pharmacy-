          ...
          {isAuthenticated && user ? (
            <div className="flex items-center gap-2">
              {user.role === "admin" && (
                <Link
                  to="/admin"
                  className="text-xs bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400 px-2 py-1 rounded-lg font-medium hover:bg-amber-200 dark:hover:bg-amber-900/50 transition"
                >
                  ⚙️ Admin
                </Link>
              )}
